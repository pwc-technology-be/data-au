...
| <<ref_TG_DS_AU,TG DS-AU>> | https://github.com/pwc-technology-be/data-au/blob/3.1/au-gml[GML application schemas, Administrative Units] | INSPIRE spatial data set encoded in GML, Administrative Units features | n/a 
